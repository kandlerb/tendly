...
const styles = StyleSheet.create({
  ...
  title:          { fontSize: text['2xl'], fontWeight: '700', color: colors.gray[900], marginBottom: 24 },
  sectionLabel:   { fontSize: text.sm, fontWeight: '600', color: colors.gray[500], marginBottom: 4, marginTop: 8 },
  row:            { flexDirection: 'row', gap: 8 },
  cityField:      { flex: 3 },
  stateField:     { flex: 1 },
  zipField:       { flex: 2 },
  validatingRow:  { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 16, paddingHorizontal: 4 },
  validatingText: { fontSize: text.sm, color: colors.brand[600] },
});

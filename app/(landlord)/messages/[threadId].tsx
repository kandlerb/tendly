...
const styles = StyleSheet.create({
  ...
  aiTagText: { color: colors.brand[600], fontSize: text.xs, marginLeft: 4 },
  ...
  bubbleTextMe: { color: colors.white, fontSize: text.base },
  bubbleTextThem: { color: colors.gray[900], fontSize: text.base },
